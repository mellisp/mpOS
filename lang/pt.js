...
window._mpLangRegister('pt', {
  ...
  'app.synth.name': 'Sintetizador',
  'app.synth.desc': 'Sintetizador modular polif\u00f3nico de 4 vozes.',
  'app.chat.name': 'Chat',
  ...
  'voice.searching': 'A pesquisar',
  'voice.helpOpened': 'Ajuda aberta',
  'voice.volumeSet': 'Volume: {level}',
  'voice.helpSearch': '"Pesquisar [termo]"',
  'voice.helpHelp': '"Ajuda"',
  'voice.helpVolume': '"Volume [subir/descer/0-10]"',
  'voice.helpTime': '"Que horas são?"',
  'voice.timeIs': 'São {time}',
  'voice.muted': 'Sem som',
  'voice.unmuted': 'Com som',
  'voice.dateIs': 'Hoje é {date}',
  'voice.showDesktop': 'Área de trabalho',
  'voice.closeAll': 'Todas as janelas fechadas',
  'voice.restore': 'Restaurado',
  'voice.weatherOpened': 'Meteorologia aberta',
  'voice.degaussed': 'Desmagnetizando...',
  'voice.newNote': 'Nova nota',
  'voice.newPainting': 'Nova pintura',
  'voice.coinHeads': 'Cara!',
  'voice.coinTails': 'Coroa!',
  'voice.coinFlip': 'Lançando moeda...',
  'voice.helpMute': '"Silenciar" / "Ativar som"',
  'voice.helpDate': '"Que dia é hoje?"',
  'voice.helpDesktop': '"Mostrar área de trabalho"',
  'voice.helpCloseAll': '"Fechar todas as janelas"',
  'voice.helpRestore': '"Restaurar [nome do app]"',
  'voice.helpWeather': '"Como está o tempo?"',
  'voice.helpDegauss': '"Degauss"',
  'voice.helpNewNote': '"Nova nota"',
  'voice.helpNewPainting': '"Nova pintura"',
  'voice.helpCoin': '"Lançar moeda"',
  'voice.typeCommand': 'Escreva um comando...',
  ...
  'synth.output': 'Sa\u00edda',
  'synth.wave': 'Onda',
  'synth.wave.sine': 'Senoidal',
  'synth.wave.saw': 'Serra',
  'synth.wave.square': 'Quadrada',
  'synth.wave.tri': 'Tri\u00e2ngulo',
  'synth.octave': 'Oitava',
  'synth.detune': 'Desafina\u00e7\u00e3o',
  'synth.filterType': 'Tipo',
  'synth.cutoff': 'Corte',
  'synth.resonance': 'Res',
  'synth.envAmt': 'Amt Env',
  'synth.attack': 'Ataque',
  'synth.decay': 'Decaimento',
  'synth.sustain': 'Sustenta\u00e7\u00e3o',
  'synth.release': 'Liberta\u00e7\u00e3o',
  'synth.shape': 'Forma',
  'synth.rate': 'Frequ\u00eancia',
  'synth.depth': 'Profundidade',
  'synth.target': 'Alvo',
  'synth.target.filter': 'Filtro',
  'synth.target.pitch': 'Tom',
  'synth.volume': 'Volume',
  'synth.voices': 'vozes',
  'synth.ready': 'Pronto',
  'synth.out': 'SA\u00cdDA',
  'synth.outputLabel': 'Sa\u00edda Sintet.',
  'synth.octDown': 'Oitava abaixo',
  'synth.octUp': 'Oitava acima',
