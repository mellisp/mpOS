...
function getItemIcon(name) {
  const icons = {
    ...
    'Weather': '<svg viewBox="0 0 512 512" x="0" y="0" width="20" height="20"><defs><linearGradient id="ei-wesg" x1="73.5" x2="122.5" y1="55.6" y2="140.5" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#f0b824"/><stop offset=".5" stop-color="#f0b824"/><stop offset="1" stop-color="#d49408"/></linearGradient></defs><symbol id="ei-wes" viewBox="0 0 196 196"><circle cx="98" cy="98" r="49" fill="url(#ei-wesg)" stroke="#e2a616" stroke-miterlimit="10" stroke-width="4"/><path fill="none" stroke="#f0b824" stroke-linecap="round" stroke-miterlimit="10" stroke-width="12" d="M98 24.3V6m0 184v-18.3M150.1 45.9l13-13M45.9 150.1l-13 13M45.9 45.9 33 33m130.1 130.1-13-13M6 98h18.3M190 98h-18.3"/></symbol><use href="#ei-wes" width="384" height="384" transform="translate(64 64)"/></svg>',
