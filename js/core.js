...
function getItemIcon(name) {
  const icons = {
    ...
    'Weather': '<defs><linearGradient id="ei-wesg" x1="3.68" x2="6.13" y1="2.78" y2="7.03" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#f0b824"/><stop offset=".5" stop-color="#f0b824"/><stop offset="1" stop-color="#d49408"/></linearGradient></defs><circle cx="10" cy="10" r="4.7" fill="url(#ei-wesg)" stroke="#e2a616" stroke-miterlimit="10" stroke-width="0.4"/><path fill="none" stroke="#f0b824" stroke-linecap="round" stroke-miterlimit="10" stroke-width="1.1" d="M10 2.4V1.5m0 17v-.9M14.5 5.5l.6-.6M5.5 14.5l-.6.6M5.5 5.5 4.9 4.9m10.2 10.2-.6-.6M1.5 10h.9M18.5 10h-.9"/>',
    ...
    'Synthesizer': '<defs><linearGradient id="ei-sy" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stop-color="#3a3a4a"/><stop offset="30%" stop-color="#2a2a3a"/><stop offset="100%" stop-color="#1a1a2a"/></linearGradient></defs><rect x="1" y="3" width="18" height="11" rx="1" fill="url(#ei-sy)" stroke="#505060" stroke-width="0.7"/><line x1="2" y1="4" x2="18" y2="4" stroke="white" stroke-width="0.4" opacity="0.15"/><rect x="3" y="5.5" width="3" height="6" rx="0.3" fill="#2a2a3a" stroke="#505060" stroke-width="0.3"/><circle cx="4.5" cy="7" r="0.6" fill="#c8a840"/><circle cx="4.5" cy="9" r="0.6" fill="#c8a840"/><rect x="7.5" y="5.5" width="3" height="6" rx="0.3" fill="#2a2a3a" stroke="#505060" stroke-width="0.3"/><circle cx="9" cy="7" r="0.6" fill="#66bb6a"/><circle cx="9" cy="9" r="0.6" fill="#66bb6a"/><rect x="12" y="5.5" width="3" height="6" rx="0.3" fill="#2a2a3a" stroke="#505060" stroke-width="0.3"/><circle cx="13.5" cy="7" r="0.6" fill="#8888ff"/><circle cx="13.5" cy="9" r="0.6" fill="#8888ff"/><rect x="2" y="15" width="2.3" height="4" rx="0.2" fill="white" stroke="#888" stroke-width="0.3"/><rect x="4.6" y="15" width="2.3" height="4" rx="0.2" fill="white" stroke="#888" stroke-width="0.3"/><rect x="7.2" y="15" width="2.3" height="4" rx="0.2" fill="white" stroke="#888" stroke-width="0.3"/><rect x="3.3" y="15" width="1.3" height="2.5" rx="0.2" fill="#333"/><rect x="5.9" y="15" width="1.3" height="2.5" rx="0.2" fill="#333"/>',
    ...
    'Chat': '<defs><linearGradient id="ei-ch" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stop-color="#e0f0ff"/><stop offset="30%" stop-color="#a0d0f0"/><stop offset="70%" stop-color="#60a8d8"/><stop offset="100%" stop-color="#3080b8"/></linearGradient></defs><rect x="2" y="2" width="16" height="11" rx="2" fill="url(#ei-ch)" stroke="#1a5a8e" stroke-width="0.8"/><path d="M6 13 L4 17 L9 13" fill="url(#ei-ch)" stroke="#1a5a8e" stroke-width="0.8"/><line x1="5" y1="6" x2="15" y2="6" stroke="white" stroke-width="0.8" opacity="0.6"/><line x1="5" y1="8.5" x2="13" y2="8.5" stroke="white" stroke-width="0.8" opacity="0.5"/><line x1="5" y1="11" x2="10" y2="11" stroke="white" stroke-width="0.8" opacity="0.4"/><ellipse cx="6" cy="4" rx="4" ry="2" fill="white" opacity="0.2"/>',
    'My Computer': '<defs><linearGradient id="ei-mc" x1="0" y1="0" x2="0.5" y2="1"><stop offset="0%" stop-color="#d0e8ff"/><stop offset="40%" stop-color="#6aafe0"/><stop offset="100%" stop-color="#1a4a6e"/></linearGradient><linearGradient id="ei-mcs" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#f0ece4"/><stop offset="100%" stop-color="#a0a098"/></linearGradient></defs><rect x="2" y="2" width="16" height="11" rx="1.5" fill="url(#ei-mc)" stroke="#1a4a6e" stroke-width="0.8"/><rect x="4" y="4" width="12" height="7" rx="0.5" fill="#e8f4ff" stroke="#7a9ab8" stroke-width="0.4"/><ellipse cx="7" cy="5.5" rx="4" ry="2" fill="white" opacity="0.3"/><rect x="8" y="13.5" width="4" height="2" fill="url(#ei-mcs)" stroke="#8a8680" stroke-width="0.4"/><rect x="5" y="15.5" width="10" height="2" rx="0.5" fill="url(#ei-mcs)" stroke="#8a8680" stroke-width="0.4"/>',
    'Files': '<defs><linearGradient id="ei-fl" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stop-color="#fff3c4"/><stop offset="30%" stop-color="#ffc107"/><stop offset="70%" stop-color="#e8a010"/><stop offset="100%" stop-color="#c49000"/></linearGradient></defs><path d="M2 5 L8 5 L10 3 L18 3 L18 17 L2 17 Z" fill="url(#ei-fl)" stroke="#a07000" stroke-width="0.8" stroke-linejoin="round"/><line x1="3" y1="6" x2="17" y2="6" stroke="white" stroke-width="0.5" opacity="0.4"/><ellipse cx="7" cy="5" rx="3" ry="1.5" fill="white" opacity="0.2"/>',
    'Run': '<defs><linearGradient id="ei-rn" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stop-color="#ffffff"/><stop offset="30%" stop-color="#f0f4ff"/><stop offset="70%" stop-color="#c8d8f0"/><stop offset="100%" stop-color="#a0b8d8"/></linearGradient></defs><path d="M3 1 L13 1 L17 5 L17 19 L3 19 Z" fill="url(#ei-rn)" stroke="#4a6a8e" stroke-width="0.8"/><path d="M13 1 L13 5 L17 5" fill="#c8d8f0" stroke="#4a6a8e" stroke-width="0.5"/><rect x="4" y="2" width="6" height="2" rx="0.5" fill="#4a8abe" opacity="0.5"/><path d="M7 9 L13 12.5 L7 16 Z" fill="#4a8abe" stroke="#2a4a6e" stroke-width="0.5"/>',
    'Task Manager': '<defs><linearGradient id="ei-tm" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0%" stop-color="#f0f8ff"/><stop offset="50%" stop-color="#d8e8f8"/><stop offset="100%" stop-color="#a0c0e0"/></linearGradient></defs><rect x="2" y="1" width="16" height="18" rx="1" fill="url(#ei-tm)" stroke="#4a6a8e" stroke-width="0.8"/><rect x="4" y="3" width="12" height="2" rx="0.3" fill="#4a8abe" opacity="0.7"/><line x1="4" y1="4" x2="16" y2="4" stroke="white" stroke-width="0.4" opacity="0.4"/><rect x="4" y="7" width="3" height="6" fill="#5aaa80" opacity="0.8"/><rect x="8.5" y="9" width="3" height="4" fill="#ffc107" opacity="0.8"/><rect x="13" y="8" width="3" height="5" fill="#ef5350" opacity="0.8"/><line x1="4" y1="15" x2="16" y2="15" stroke="#8a9ab8" stroke-width="0.4"/><line x1="4" y1="17" x2="12" y2="17" stroke="#8a9ab8" stroke-width="0.4"/>',
