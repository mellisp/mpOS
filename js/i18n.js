...
(function () {
  ...
  registerLang('en', {
    ...
    'app.synth.name': 'Synthesizer',
    'app.synth.desc': '4-voice polyphonic modular synthesizer.',
    'app.chat.name': 'Chat',
    ...
    'voice.helpOpened': 'Help opened',
    'voice.volumeSet': 'Volume: {level}',
    'voice.helpSearch': '"Search for [term]"',
    'voice.helpHelp': '"Help"',
    'voice.helpVolume': '"Volume [up/down/0-10]"',
    'voice.helpTime': '"What time is it?"',
    'voice.timeIs': 'The time is {time}',
    'voice.muted': 'Muted',
    'voice.unmuted': 'Unmuted',
    'voice.dateIs': 'Today is {date}',
    'voice.showDesktop': 'Desktop shown',
    'voice.closeAll': 'All windows closed',
    'voice.restore': 'Restored',
    'voice.weatherOpened': 'Weather opened',
    'voice.degaussed': 'Degaussing...',
    'voice.newNote': 'New note',
    'voice.newPainting': 'New painting',
    'voice.coinHeads': 'Heads!',
    'voice.coinTails': 'Tails!',
    'voice.coinFlip': 'Flipping coin...',
    'voice.helpMute': '"Mute" / "Unmute"',
    'voice.helpDate': '"What\'s the date?"',
    'voice.helpDesktop': '"Show desktop"',
    'voice.helpCloseAll': '"Close all windows"',
    'voice.helpRestore': '"Restore [app name]"',
    'voice.helpWeather': '"What\'s the weather?"',
    'voice.helpDegauss': '"Degauss"',
    'voice.helpNewNote': '"New note"',
    'voice.helpNewPainting': '"New painting"',
    'voice.helpCoin': '"Flip a coin"',
    'voice.typeCommand': 'Type a command...',
    ...
    'synth.output': 'Output',
    'synth.wave': 'Wave',
    'synth.wave.sine': 'Sine',
    'synth.wave.saw': 'Saw',
    'synth.wave.square': 'Square',
    'synth.wave.tri': 'Tri',
    'synth.octave': 'Octave',
    'synth.detune': 'Detune',
    ...
    'synth.depth': 'Depth',
    'synth.target': 'Target',
    'synth.target.filter': 'Filter',
    'synth.target.pitch': 'Pitch',
    'synth.volume': 'Volume',
    'synth.voices': 'voices',
    'synth.ready': 'Ready',
    'synth.out': 'OUT',
    'synth.outputLabel': 'Synth Out',
    'synth.octDown': 'Octave down',
    'synth.octUp': 'Octave up',
